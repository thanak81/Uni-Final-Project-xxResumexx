...
function EditResume({params}) {
  ...
  const { isLoading, data:resumeDataById, error, isError } = useQuery("resume",()=> getResumeById(id));
  ...
  return (
    <>
      <div className="flex gap-10 lg:gap-5 flex-col justify-center  lg:flex-row  mt-5 lg:h-screen">
        ...
        <FormProviderComp id={id} mutation={mutation} data={data} handleTemplate={handleTemplate} selectedTemplate={selectedTemplate} resumeDataById={resumeDataById} printRe={printRef}/>
