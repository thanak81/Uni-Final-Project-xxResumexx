...
function BasicsTemplate({resumeData}) {
  ...
  return (
      <div className="text-white pt-10 pb-5">
        <div className="text-2xl font-bold text-center">{resumeData.data.basics.name? resumeData.basics.name :"Thanak Mech"}</div>
        <div className="text-center">{resumeData.data.basics.summary}</div>
        <div className="gap-5">
