...
function WorkForm({ autoSaveData }) {
...
function Work({ index, handleRemove, register, watchPresent, autoSaveData }) {
  let status;
    ...
    <>
      ...
      <div className="w-full flex gap-5 items-center">
        <InputComp
          ...
          label={"Company Name"}
          defaultValue={
            autoSaveData?.data?.work[index]?.company
              ? autoSaveData?.data?.work[index].company
              : ""
          }
      ...
      <div className="w-full">
        <InputComp
          ...
          defaultValue={
            autoSaveData?.data?.work[index]?.position
              ? autoSaveData?.data?.work[index].position
              : ""
          }
          // isInvalid = {true}
      ...
      <div className="w-full flex items-center justify-end gap-2">
        <input
          ...
          name="work.present"
          defaultValue={
            autoSaveData?.data?.work[index]?.present
              ? autoSaveData?.data?.work[index].present
              : ""
          }
      ...
      <div className="w-full">
        <div className="flex gap-2">
          <InputComp
            ...
            defaultValue={
              autoSaveData?.data?.work[index]?.startYear
                ? autoSaveData?.data?.work[index].startYear
                : ""
            }
            // value={value}
          ...
          <InputComp
            ...
            defaultValue={
              autoSaveData?.data?.work[index]?.endYear
                ? autoSaveData?.data?.work[index].endYear
                : ""
            }
            // value={status? "" : return}
      ...
      <div className="w-full">
        <Tiptap
          ...
          data={
            autoSaveData?.data?.work[index]?.summary
              ? autoSaveData?.data?.work[index].summary
              : ""
          }
        />
