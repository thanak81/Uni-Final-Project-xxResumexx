...
function PDFTemplate1() {
  ...
  return (
    <>
      <input className="border " type="text" value={"getttss"} onChange={(e) => e.target.value} />
      <Document>
        <Page style={styles.body}>
          <Text style={styles.header} fixed>
            ~ Ckkkkmmmmted with react-pdf ~
          </Text>
          <Text style={styles.title}>{input}Thanak Mech</Text>
          <Text style={styles.author}>Miguel de Cervantes</Text>
          <Text style={styles.subtitle}>
            111Capítulo I: Quasde trata de la condición y ejercicio del famoso
