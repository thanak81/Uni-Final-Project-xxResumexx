...
function Template2Styling() {
  ...
  return (
    <>
      ...
      />
      {line !== 30 && (
        <Button className="my-2 cursor-pointer" onClick={() => setLine(30)}>
          Reset
        </Button>
      )}
      <Slider
      ...
      />
      {gap !== 5 && (
        <Button className="my-2 cursor-pointer" onClick={() => setGap(4)}>
          Reset
        </Button>
      )}
    </>
...
export default Template2Styling;
